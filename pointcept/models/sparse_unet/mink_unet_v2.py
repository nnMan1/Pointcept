...
from .mink_unet_sparse.resnet import ResNetBase, get_norm
from .mink_unet_sparse.common import ConvType, NormType, conv, conv_tr
from .mink_unet_sparse.resnet_block import BasicBlock, Bottleneck
...
class Res16UNetBase(ResNetBase):
    ...
    def __init__(
        ...
        print(in_channels, out_channels, config, D)
