...
from .nn import CrossAttentionLayer, SelfAttentionLayer, FFNLayer
from .utils import compute_stats, select_masks, db_scan, pad_data
...
class Encoder(nn.Module):
    ...
    def __init__(self, backbone, out_channels, backbone_out_channels):
        ...
        self.backbone = build_model(backbone) #SpUNet(**backbone)
    ...
    def forward(self, data):
        ...
        return {
                'features': pcd_features[0].features,
                'layer_features': pcd_features[-1],
                'offset': offset
            }
