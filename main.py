...
for s in dataset:
    ...
    for i, c in enumerate(s['seed_ids']):
        pcd = o3d.geometry.PointCloud()
        pcd.points = o3d.utility.Vector3dVector(s['coord'][s['instance'] == i])
        pcd.colors = o3d.utility.Vector3dVector(colors[s['instance']% len(colors)][s['instance'] == i])
