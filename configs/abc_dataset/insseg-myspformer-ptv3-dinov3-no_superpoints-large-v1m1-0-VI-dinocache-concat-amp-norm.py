...
# NORMALIZED CONCAT-FUSION + AMP on the MERGED-SYNTHETIC dataset.
# Same model as insseg-...-dinocache-h5-concat-amp-norm (concat fusion with
# proj_norm + concat_norm, AMP), but trained on the merged-synthetic
# MechanicalAssemblySynth data (data/segment-assembly-merged-synthetic/data)
# with the mech_synth DinoV3 feature cache, instead of the abc HDF5 shards.
#
