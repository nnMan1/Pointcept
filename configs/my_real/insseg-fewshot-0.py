    ...
    train=dict(
        ...
        transform=[
            dict(
                ...
                features_root=
                '/leonardo_scratch/large/userexternal/vdosljak/dino_features/motor_synth/features'
            ),
            ...
            dict(
                type='Collect',
                keys=('coord', 'grid_coord', 'segment', 'instance', 'border',
                      'image_features', 'mappings_src', 'mappings_tgt',
                      'seed_ids', 'seg_indices', 'instance_segment', 'path',
                      'name', 'inverse'),
                feat_keys=('coord', ),
        ...
        transform=[
            ...
            dict(
                ...
                keys=('coord', 'grid_coord', 'segment', 'instance', 'border',
                      ...
                      'instance_segment', 'seed_ids', 'seg_indices', 'path',
                      'name', 'inverse'),
                feat_keys=('coord', ),
                offset_keys_dict=dict(
                    offset='coord',
