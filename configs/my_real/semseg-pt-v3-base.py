...
enable_amp = False
# resume=True
weight='/home/exp/fuselage_instance/semseg-spunet-v1m1-0-base/model/model_best.pth'
...
model = dict(
    ...
    criteria=[dict(type='CrossEntropyLoss', loss_weight=1.0, ignore_index=-1, weight=[0.05, 0.95, 0.95]),
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type='MeshToPointCloud', num_points=2000000),
            dict(type='CropAround', semantic_class=1, offset_std=20, diameter_mean=300, diameter_std=5, ord=1, p=1),
            dict(
                type="GridSample",
                grid_size=0.5,
                hash_type="fnv",
    ...
    val=dict(
        ...
        transform=[
            ...
            dict(type='MeshToPointCloud', num_points=2000000, keys=("coord", "segment", "instance", "seg_indices")),
            dict(type='CropAround', semantic_class=1, offset_std=20, diameter_mean=300, diameter_std=5, ord=1, p=1,
                 keys=("coord", "segment", "instance", 'origin_coord', 'origin_segment', 'origin_instance', "seg_indices")),
            dict(
                type="GridSample",
                grid_size=0.5,
                hash_type="fnv",
...
hooks = [
    # dict(type="CheckpointLoader", keywords=["backbone.conv_input.0.", "backbone.final"], replacement=["dummy.", "dummy."]),
