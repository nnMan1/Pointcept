...
weight = 'exp/my_real/insseg-myspformer-dino-no_superpoints-large-v1m1-0-spunet-base_I/model/model_best.pth'
...
hooks = [
    ...
    dict(type="CheckpointLoader", keywords=["module.", "module.encoder.backbone."], 
