    ...
    train=dict(
        ...
        transform=[
            ...
            dict(
                ...
                feat_keys=("coord"),
                offset_keys_dict=dict(offset="coord", origin_offset="origin_coord", image_offset="images", face_offset="face"),
...
hooks = [
    dict(type="CheckpointLoader", keywords=["module.", "module.encoder."], replacement=["module.", "dummy"]),
