...
enable_amp = True
# resume=True
# weight='/home/exp/fuselage/semseg-spunet-v1m1-0-base_250x250x250_hard_rot/model/model_last.pth'
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="RandomRotate", angle=[-1 / 25, 1/25], axis="x", p=0.5),
            dict(type="RandomRotate", angle=[-1 / 25, 1/25], axis="y", p=0.5),
