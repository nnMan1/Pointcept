...
names=['other', 'rivets', 'hole']
data_root = 'data/Fuselage/crops_250x250x250_holes'
val_data_root = 'data/Fuselage/new_data_prepared'
...
data = dict(
    ...
    train=dict(
        ...
        test_mode=False,
        classes=['body', 'hole', 'rivets', 'panel', 'body1'],
        augment_holes=True,
        merged_classes=[['body', 'body1', 'panel']]
    ),
    val=dict(
        type=dataset_type,
        split="val",
        ...
        test_mode=False,
        classes=[
            'other', 'hole', 'rivet', 'ruber-seal',
            'rivet_t1' ,'sting-stif',  'main_panel'
        ],
        merged_classes=[['other', 'ruber-seal', 'sting-stif', 'main_panel'], ['rivet', 'rivet_t1']]
    ),
    test=dict(
        type=dataset_type,
        split="val",
