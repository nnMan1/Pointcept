...
weight = 'exp/abc_dataset/insseg-myspformer-ptv3-dino-large-v1m1-0_II/model/model_best.pth'
...
# dataset settings
dataset_type = "HDF5_Dataset"
data_root = "/home/data/partnet/processed/"
...
data = dict(
    ...
    val=dict(
     ...
     test=dict(
        type='HDF5_Dataset',
        split='test',
        data_root='/home/data/Partnet/data/processed/chair/test',
        image_size=(448, 448),
        transform=[
            dict(type='CenterShift', apply_z=True),
            dict(
