...
# MOTOR FINETUNE of insseg-myspformer-ptv3-dinov3-no_superpoints-large-v1m1-0-VI-dinocache-concat-amp-norm-rescale.
# Init: exp/abc_dataset/insseg-myspformer-ptv3-dinov3-no_superpoints-large-v1m1-0-VI-dinocache-concat-amp-norm-rescale/model/model_best.pth (merged pretrain, ep100).
...
weight = 'exp/abc_dataset/insseg-myspformer-ptv3-dinov3-no_superpoints-large-v1m1-0-VI-dinocache-concat-amp-norm-rescale/model/model_best.pth'
