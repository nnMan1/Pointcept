...
weight = '/home/exp/my_synth/insseg-myspformer-ptv3-dinov3-no_superpoints-large-v1m1-0-spunet-base-with-screws/model/model_best.pth'
...
hooks = [
    ...
    dict(type="CheckpointLoader", keywords=["module.", "decoder.mask_modules.0.class_embed_head.2", "semantic_ce_loss.weight"], 
                                 replacement=["module.",  "dummy", "dummy"],),
