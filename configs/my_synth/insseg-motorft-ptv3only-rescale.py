...
# MOTOR FINETUNE of insseg-myspformer-ptv3-only-no_superpoints-large-v1m1-0-VI-amp-rescale.
# Init: exp/abc_dataset/insseg-myspformer-ptv3-only-no_superpoints-large-v1m1-0-VI-amp-rescale/model/model_best.pth (merged pretrain, ep100).
...
weight = 'exp/abc_dataset/insseg-myspformer-ptv3-only-no_superpoints-large-v1m1-0-VI-amp-rescale/model/model_best.pth'
