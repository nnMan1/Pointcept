...
# MOTOR FINETUNE of insseg-myspformer-ptv3-dinov3-no_superpoints-large-v1m1-0-VI-dinocache-concat-amp-norm-rescale-dinov3L.
# Init: exp/abc_dataset/insseg-myspformer-ptv3-dinov3-no_superpoints-large-v1m1-0-VI-dinocache-concat-amp-norm-rescale-dinov3L/model/model_best.pth (merged pretrain, ep100).
...
weight = 'exp/abc_dataset/insseg-myspformer-ptv3-dinov3-no_superpoints-large-v1m1-0-VI-dinocache-concat-amp-norm-rescale-dinov3L/model/model_best.pth'
...
features_root_synth = "/leonardo_scratch/large/userexternal/vdosljak/dino_features/motor_synth_dinov3L/features"
features_root_real = "/leonardo_scratch/large/userexternal/vdosljak/dino_features/cetim_real_dinov3L/features"
...
model = dict(
    ...
    encoder=dict(
        ...
        model1_config=dict(
            ...
            model_type=None,  # precomputed dinov3L features
            patch_size=16,
            model_name=None,
            fts_dim=1024,
            out_fts_dim=256,
