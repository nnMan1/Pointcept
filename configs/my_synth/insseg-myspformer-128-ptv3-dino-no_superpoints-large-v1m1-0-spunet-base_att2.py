...
# encoder.backbone.feature_extractor2.backbone.enc.enc3.block4.attn.proj.bias

hooks = [
    dict(type="CheckpointLoader", 
         keywords=["module.", "encoder.backbone", "module.encoder.dino.model", "module.encoder.dino_mapping_mlp"], 
         replacement=["module.", "encoder.backbone.feature_extractor2.backbone", "module.encoder.backbone.feature_extractor1.model", "module.encoder.backbone.feature_extractor1.proj"]),
