...
weight = 'exp/abc_dataset/insseg-myspformer_ptv3-no-superpoints-v1m1-0-spunet-base/model/model_last.pth'
...
data_root = "data/segment-motor-synthetic/data/merged_v2"
