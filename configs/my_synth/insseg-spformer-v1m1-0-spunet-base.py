...
resume=True
weight='exp/my_synth/insseg-spformer-v1m1-0-spunet-base_cont/model/model_last.pth'
...
data_root = "data/my_synth/electromotors/scanns"
...
data = dict(
    ...
    val=dict(
        ...
        split='train',
        data_root='data/mechanical-assemblies',
        transform=[
            dict(type="CenterShift", apply_z=True),
            dict(
                type="Copy",
