...
# MOTOR FINETUNE of insseg-myspformer-ptv3-dinov3-no_superpoints-large-v1m1-0-VI-dinocache-concat-amp-norm-rescale-dinov2L.
# Init: exp/abc_dataset/insseg-myspformer-ptv3-dinov3-no_superpoints-large-v1m1-0-VI-dinocache-concat-amp-norm-rescale-dinov2L/model/model_best.pth (merged pretrain, ep100).
# Finetunes on the 47 motor-synthetic scenes (ftrain=43/fval=5),
# keeping the source recipe (incl. RandomRescaleDiag). Same protocol
# as the original motor-ft (real AP50 0.3163) but from a stronger base.

weight = 'exp/abc_dataset/insseg-myspformer-ptv3-dinov3-no_superpoints-large-v1m1-0-VI-dinocache-concat-amp-norm-rescale-dinov2L/model/model_best.pth'
...
features_root_synth = "/leonardo_scratch/large/userexternal/vdosljak/dino_features/motor_synth_dinov2L/features"
features_root_real = "/leonardo_scratch/large/userexternal/vdosljak/dino_features/cetim_real_dinov2L/features"
...
model = dict(
    ...
    encoder=dict(
        ...
        model1_config=dict(
            ...
            model_type=None,  # precomputed dinov2L features
            patch_size=14,
            model_name=None,
            fts_dim=1024,
            out_fts_dim=256,
