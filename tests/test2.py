...
checkpoint = torch.load('/home/exp/abc_dataset/insseg-mask3d-v1m1-0-spunet-base-dense2/model/model_best.pth')
...
ds = Fuselage(
        ...
        transform=[
            ...
            dict(type='RandomSeed', n_points = 500),
            dict(type="ToTensor"),
            dict(
                type="Collect",
                keys=(
